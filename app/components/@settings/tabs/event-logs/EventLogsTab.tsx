...
export function EventLogsTab() {
  ...
  const exportAsPDF = () => {
    try {
      ...
      // Add subtitle with MakeThis.Dev
      doc.setFontSize(12);
      doc.setFont('helvetica', 'normal');
              doc.text('MakeThis.Dev - AI Development Platform', margin, 45);
      yPos = 70;
      ...
      for (let i = 1; i <= totalPages; i++) {
        ...
        // Add footer text
        doc.text('Generated by MakeThis.Dev', margin, doc.internal.pageSize.getHeight() - 10);
